...
def time_vs_elements_insertion(arrays):
    sizes = []
    times = []
...
best_case_sizes, best_case_times = time_vs_elements_insertion(best_case_arrays)
worst_case_sizes, worst_case_times = time_vs_elements_insertion(worst_case_arrays)
average_case_sizes, average_case_times = time_vs_elements_insertion(average_case_arrays)
...
plt.ylabel('Time (s)')
plt.title('Time vs Number of Elements (Insertion Sort)')
plt.legend()
plt.grid(True)
plt.show()
